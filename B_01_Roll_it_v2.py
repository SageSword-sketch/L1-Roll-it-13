...
def initial_points(which_player):
    ...
    # Roll the dice for the user and the note if they got a double
...
while comp_score < game_goal and user_score < game_goal:
    ...
    # if the computer has fewer poitns, switch the computer to 'player'
    else:
    ...
    while player_1_points < 13 and player_2_points < 13:
        ...
        # first person ro9lls the die and score is updated
    ...
    # accociate player points with either the user or the computer
